...
def build_estimator(algorithm_id: str, task_type: str, hyperparameters: Optional[Dict[str, Any]] = None):
...
def train_and_package(
    ...
    estimator = build_estimator(algorithm_id=algorithm_id, task_type=task_type, hyperparameters=hyperparameters)
